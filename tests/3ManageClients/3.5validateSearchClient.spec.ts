...
rolesToTest.forEach(role => {
    ...
    test.describe.parallel('Client List - Validate Sorting of Records', () => {
        ...
        test(`Client List - Validate Sorting as ${role}`, async() => {
            ...
            await manageClientsPage.searchNonExistingClient(testData.manageClient.nonExistingClient);
            await manageClientsPage.searchExistingClient(testData.manageClient.existingClient);
        })
    })
})